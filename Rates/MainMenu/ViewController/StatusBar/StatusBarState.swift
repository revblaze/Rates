...
enum StatusBarState {
  ...
  var text: String {
    ...
    case .failedToUpdate: return "An error occured while downloading the exchange rate data. Please click the reload button to try again. 􀄫"
    case .noConnectionAndPrefersUpdate: return "New exchange rate data may be available, but we were unable to check. Please check your network connection Please click the reload button to try again. 􀄫"
